...
let maxHeightWords = $derived(shortNumber(ore.data.ore.MaxElevation));
let minHeightWords = $derived(shortNumber(ore.data.ore.MinElevation));
</script>
